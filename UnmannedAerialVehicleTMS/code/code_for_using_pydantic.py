...
class Type6(Enum):
    UnmannedAerialVehicleTMS = 'UnmannedAerialVehicleTMS'


class UnmannedAerialVehicleTMS(BaseModel):
    ...
    operationalInstance: Optional[AnyUrl] = Field(
        None,
    ...
    softwareApplication: Optional[SoftwareApplication] = Field(None, description='')
