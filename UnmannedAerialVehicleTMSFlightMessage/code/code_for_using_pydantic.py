...
class FlightDeclaration(BaseModel):
    actualLandingTime: Optional[AwareDatetime] = None
    actualTakeOffTime: Optional[AwareDatetime] = None
    contactUrl: Optional[AnyUrl] = None
    expectTelemetry: Optional[bool] = None
    idents: Optional[List[str]] = None
    operationMode: Optional[OperationMode] = None
    originatingParty: Optional[str] = None
    parts: Optional[List[str]] = None
    purpose: Optional[str] = None


class FlightMessage(BaseModel):
    flightDeclaration: Optional[FlightDeclaration] = None
...
class Type6(Enum):
    UnmannedAerialVehicleTMSFlightMessage = 'UnmannedAerialVehicleTMSFlightMessage'


class UnmannedAerialVehicleTMSFlightMessage(BaseModel):
    ...
    observedAt: Optional[AwareDatetime] = Field(
        None, description='Indicates the date/time of the UAVFlightMessage record'
    )
