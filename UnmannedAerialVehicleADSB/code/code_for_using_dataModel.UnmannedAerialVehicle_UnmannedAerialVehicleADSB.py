...
dataModel = "UnmannedAerialVehicleADSB"
...
observedAt = "{'type': 'Property', 'value': {'@type': 'DateTime', '@value': '2016-08-23T10:18:16Z'}}"
attribute = "observedAt"
value = observedAt
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

originatedByUnmannedAerialVehicle = {'type': 'Property', 'value': False}
attribute = "originatedByUnmannedAerialVehicle"
value = originatedByUnmannedAerialVehicle
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))
