...
class Type6(Enum):
    UnmannedAerialVehicleADSB = 'UnmannedAerialVehicleADSB'


class UnmannedAerialVehicleADSB(BaseModel):
    UnmannedAerialVehicleADSBroadcast: Optional[str] = Field(
        None,
    ...
    observedAt: Optional[AwareDatetime] = Field(
        None, description='Indicates the date/time of the DBS broadcast'
    )
    originatedByUnmannedAerialVehicle: Optional[bool] = Field(
        None,
