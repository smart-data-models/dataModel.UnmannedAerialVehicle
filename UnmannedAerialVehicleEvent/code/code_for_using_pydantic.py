...
class EventType(Enum):
    illegalFlight = 'illegalFlight'
    closeToUnpermittedAirspace = 'closeToUnpermittedAirspace'
    overSpeed = 'overSpeed'
    overHeight = 'overHeight'
    illegalWork = 'illegalWork'
...
class Type6(Enum):
    UnmannedAerialVehicleEvent = 'UnmannedAerialVehicleEvent'


class UnmannedAerialVehicleEvent(BaseModel):
    ...
    startAt: Optional[AwareDatetime] = Field(
        None, description='Indicates the date/time of when the event started'
    )
